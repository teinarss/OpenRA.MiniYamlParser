...
//        public static MiniYaml Save<T>(T o, bool includePrivateByDefault = false)
//        {
...
//            var genericType = typeof(ConverterCase<>).MakeGenericType(t);

//            var converterCase = (ConverterCase)Activator.CreateInstance(genericType);
...
//    public abstract class ConverterCase
//    {
//		public 
//    }

//	public class ConverterCase<T> : ConverterCase
//	{
